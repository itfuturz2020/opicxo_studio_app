...
class _ChangeThemeState extends State<ChangeTheme> {
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          ...
                          child: Image.network("${ThemeClass[index].Image}",
                            height: 420,
                            width: 400,
                          ),
                        ),
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () async {
                                      Future<String> mess=Services.UpdateTheme(MemberId,ThemeClass[index].Id);
                                      print("mess");
                                      print(mess);
                                      String profileUrl = cnst.profileUrl
                                          .replaceAll(MemberId,ThemeClass[index].Id);
                                      if (await canLaunch(profileUrl)) {
                                        await launch(profileUrl);
                                      } else {
                                        throw 'Could not launch $profileUrl';
  ...
  Widget buildAppBar(BuildContext context) {
    return new AppBar(centerTitle: false, title: Text("Theme"), actions: <Widget>[
    ]);
  }
}
