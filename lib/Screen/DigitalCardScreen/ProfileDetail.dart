...
class _ProfileDetailState extends State<ProfileDetail>
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        Services.UpdateDigitalProfileMember(
          prefs.getString(Session.Image),
          prefs.getString(Session.Image),
          prefs.getString(Session.Name),
          prefs.getString(Session.Mobile),
          prefs.getString(Session.Email),
          "",
          "",
          "",
          "",
          ...
          "",
          "",
          prefs.getString(Session.Bio),
          prefs.getString(Session.CompanyName),
          "",
          prefs.getString(Session.Mobile),
          "",
          "",
          ...
          prefs.getString(Session.Email),
          "",
          prefs.getString(Session.Address),
          "",
          "",
          memberId,
  ...
  SetDataToController() async {
    ...
    txtMobile.text = prefs.getString(Session.Mobile);
    txtEmail.text = prefs.getString(Session.Email);
    ...
    txtYoutube.text = "";
    txtIntagram.text = "";
    txtAbout.text = prefs.getString(Session.Bio);
    //txtPersonalPAN.text = "${profileList["name"]}";

    //Company Data
    txtCompany.text = prefs.getString(Session.CompanyName);
    // txtRole.text = "${profileList["name"]}";
    txtPhone.text = prefs.getString(Session.Mobile);
    txtCompanyEmail.text = prefs.getString(Session.Email);
