      ...
      res.then((data) async {
        ...
        if (data != null && data.length > 0) {
          ...
          if (data.length > 1) {
            ...
            int index=0;
            SharedPreferences prefs = await SharedPreferences.getInstance();
            await prefs.setString(cnst.Session.MemberId, data[index].Id);
            ...
            //     cnst.Session.Company, widget.data[index].Company);
            // await prefs.setString(
            //     cnst.Session.ReferCode, widget.data[index].MyReferralCode);
            // await prefs.setBool(
            //     cnst.Session.IsActivePayment, widget.data[index].IsActivePayment);
