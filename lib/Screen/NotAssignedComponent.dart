...
class NotAssignedComponent extends StatefulWidget {
  var NotAssigned, Id;

  NotAssignedComponent(this.NotAssigned, this.Id);

  @override
  _NotAssignedComponentState createState() => _NotAssignedComponentState();
}

class _NotAssignedComponentState extends State<NotAssignedComponent> {
  bool _lights = false;
  ProgressDialog pr;
  bool isLoading = true;
  ...
  _getdata() async {
    if (widget.NotAssigned["IsSelected"].toString() == "1") {
      setState(() {
        _lights = true;
      });
    }
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        var data = {
          ...
          "GalleryId": widget.NotAssigned["Id"],
        };
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => SubAlbumEvent(
                    widget.NotAssigned["Id"], widget.NotAssigned["Title"])));
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: widget.NotAssigned["GalleryCover"] != "" &&
                      widget.NotAssigned["GalleryCover"] != null
                  ? FadeInImage.assetNetwork(
                      ...
                      fit: BoxFit.fill,
                      image:
                          "${cnst.ImgUrl}" + widget.NotAssigned["GalleryCover"])
                  : Image.asset(
                      "images/no_image.png",
                      width: MediaQuery.of(context).size.width,
                      height: 120,
